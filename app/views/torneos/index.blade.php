...
@section('breadcrumb')
	...
	@endif
    <li>
        <a href="javascript:void('modificarEsto');">
            <i class="fa fa-plus"></i>Nuevo torneo</a>
    </li>
@stop
		...
		<table class="tabla">
			<tbody>
			    ...
			    <tr>
			        ...
			        <td>{{ $e->cantidad }}</td>
			        <td>
			            <a class="borrar" href="javascript:void('modificarEsto');" onclick="javascript:return borrarItem('{{ $e->nombre }}');">
